...
Launches the [cypress](https://www.cypress.io/) test runner and allows to launch end to end tests in the interactive mode.

### `yarn cy:run`

Launches all the end to end tests in headless mode
